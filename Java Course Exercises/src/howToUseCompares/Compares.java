...
public class Compares {
	...
	public static void main(String[] args) 
	{
		...
		/*Sorting with using comparable --> implementing our own sort algorithm for an object that does not comply with the
		types (int, String, etc..) within the regular sort.*/
		...
		/*Sorting with using comparator --> implementing our own sort algorithm for a known type which can be sorted by the regular
		sort.*/
